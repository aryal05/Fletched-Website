...
const Navbar = () => {
  ...
  return (
   ...
   <div className='flex items-center gap-6'>
    ...
    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text[8px]'>9</p>
    </Link>
   ...
   <div className={`aboslute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full': 'w-0'}`}>
